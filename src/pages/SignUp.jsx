  ...
  return (
    <>
      <div className='flex items-center justify-center'>
        <div className='w-[100vw] h-screen px-5 py-7 pb-10 md:w-100 xl:border-1 xl:border-gray-300 flex flex-col gap-5 bg-[#F7F8F9]'>
          ...
          <form action="" id="signUpForm" className='flex flex-col gap-1' onSubmit={() => handleSubmit(event)} >
            <div className='flex flex-col'>
              ...
              <input type="text" className='border-1 border-gray-400 px-3 py-2 bg-white rounded' placeholder='Enter full name' required
                value={userName}
            ...
            <div className='flex flex-col'>
              ...
              <input type="text" className='border-1 border-gray-400 px-3 py-2 rounded bg-white' placeholder='Enter email address'
               required
              value={email}
